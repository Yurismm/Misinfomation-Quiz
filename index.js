...
const GAME_LENGTH = 5;
const SKILL_NAME = 'Misinformation Quiz';
const FALLBACK_MESSAGE = `The ${SKILL_NAME} skill can\'t help you with that.  It can ask you questions about Misinformation if you say start game. What can I help you with?`;
